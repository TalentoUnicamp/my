...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCompanyList() {
                self = this;
                axios.get(this.admin.api.list_companies)
                .then(function (data) {
            ...
            deleteCompany(company_id) {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        axios.delete(this.admin.api.delete_company + company_id)
                        .then(function(data) {
            ...
            createCompany(company_name) {
                axios.post(this.admin.api.create_company, {
                    name: company_name
                })
                .catch(function (error) {
                    console.error(error);
            ...
            getEmployeeList() {
                self = this;
                axios.get(this.admin.api.list_employees)
                .then(function (data) {
            ...
            mapEmployee(employee) {
                return {
                    ...
                    unique_id: employee['profile.unique_id'],
            ...
            employeeUpdated(employee) {
                employee = this.mapEmployee(employee);
                this.employeeList = updateOnList(this.employeeList, employee, 'unique_id');
            },
            employeeDeleted(employee) {
                employee = this.mapEmployee(employee);
                this.employeeList = deleteFromList(this.employeeList, employee, 'unique_id');
            },
            deleteEmployee(unique_id) {
                axios.delete(this.admin.api.delete_employee + unique_id)
                .then(function(data) {
            ...
            createEmployee(employeeList, companyId) {
                for (var employee in employeeList) {
                    ...
                    axios.post(this.admin.api.create_employee, {
                        unique_id: unique_id,
        ...
        mounted: function () {
            // Companies
            this.getCompanyList();
            var createcompany = new ModelSubscription('company', 'Company', 'create');
            var deletecompany = new ModelSubscription('company', 'Company', 'delete');
            ...
            var createemployee = new ModelSubscription('company', 'Employee', 'create');
            var updateemployee = new ModelSubscription('company', 'Employee', 'update');
            var deleteemployee = new ModelSubscription('company', 'Employee', 'delete');
            ...
            // Users
            this.getUserList();
            var createuser = new ModelSubscription('user_profile', 'Profile', 'create');
            var updateuser = new ModelSubscription('user_profile', 'Profile', 'update');
            var deleteuser = new ModelSubscription('user_profile', 'Profile', 'delete');
            createuser.connect();
            updateuser.connect();
            deleteuser.connect();

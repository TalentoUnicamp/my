<template>
    <div v-bind:class="{ui: loadingCamera, segment: loadingCamera}">
        ...
        <div v-if="!userAllowed">
            ...
            <p>
                O check in funciona usando a câmera do seu dispositivo. Você deve usá-la para escanear os QR codes dos empregados e confirmar o check in assim que verificar que a leitura foi correta.
            </p>
            <p>
...
export default {
    ...
    methods: {
        ...
        onDecode(unique_id) {
            ...
            self = this;
            axios
                .post(this.admin.api.fetch_checkin_employee, {
                    unique_id: unique_id
                })
                .then(function(data) {
                    ...
                    // If results are ok
                        ...
                        swal({
                            ...
                            if (fazercheckin) {
                                axios
                                    .post(self.admin.api.checkin_employee, {
                                        unique_id: unique_id
                                    })
                                    .then(function(data) {
